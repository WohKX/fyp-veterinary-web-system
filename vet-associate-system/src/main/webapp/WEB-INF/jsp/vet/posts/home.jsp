			...
			<div class="row">
				...
				<div class="col-12 col-sm-8 mt-5">
					<div class="row justify-content-start">
						<form action="/home/vet/search" method="post">
							<div class="row mb-5">
								<div class="col-sm-4">
					...
					<div class="card text-center text-dark bg-light mb-3">
						<div class="card-body">
							<form action="/home/vet/newPost" method="post"
								enctype="multipart/form-data">
								<div class="row mb-3 justify-content-start">
									<div class="col-12 col-sm-3">
										<label for="username" class="form-label fs-4">${veterinarian.realName}</label>
									</div>
								</div>
								<div class="row mb-3">
									<textarea class="form-control fs-5" id="descriptions"
								...
								<div class="row mb-3">
									...
									<div class="col-12 col-sm-6 justify-content-end">
										<button type="submit" class="btn btn-inline-primary fs-5"
					...
					<c:choose>
						<c:when test="${socialNetworks.size() > 0}">
							<c:forEach items="${socialNetworks}" var="socialNetwork">
								<div class="card mb-3">
									<form action="/home/vet/view" method="get">
										<div class="card-body">
											<div class="row mt-5">
												<div class="col-sm">
													<div
