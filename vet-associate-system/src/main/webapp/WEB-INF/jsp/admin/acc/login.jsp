		...
		<div class="container-sm justify-content-center mt-5"
			...
			<form action="/login/admin" method="post">
				<div class="card text-center text-dark bg-light">
					<div class="card-header fs-3">Admin Login</div>
					<div class="card-body">
						<div class="mb-3 row">
							<label for="userIdLabel" class="col-sm-3 col-form-label">UserID</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="userId"
									id="userId" placeholder="Insert Your ID here" />
							</div>
							<div class="col-sm-3">
...
<script src="${pageContext.request.contextPath}/js/adminPage/login.js"></script>
</html>