...
<title>Admin Add Clinic/Hospital</title>
					...
					<div class="row">
						...
						<div class="col-12 col-sm-8 mt-3">
							<div class="container-sm mt-5">
								<form action="/manageUCH/admin/createCH" method="post">
...
<script
	src="${pageContext.request.contextPath}/js/adminPage/createCH.js"></script>
