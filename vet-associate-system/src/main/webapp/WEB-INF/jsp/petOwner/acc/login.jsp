...
<body>
  ...
  ">
		<div class="container-sm justify-content-center mt-5"
			style="height: 100vh">
			<form action="/login/petOwner" method="post">
				<div class="card text-center text-dark bg-light">
					<div class="card-header fs-3">Pet Owner Login</div>
					<div class="card-body">
						<div class="mb-3 row">
							<label for="userIdLabel" class="col-sm-3 col-form-label">UserID</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="userId"
									id="userId" placeholder="Insert Your Email here"
									onkeyup="valUserId()" onblur="valUserId()"
									onchange="valUserId()" oninput="valUserId()" />
							</div>
							<div class="col-sm-3">
						...
						<div class="mb-3 row justify-content-center">
							<div class="col-sm-6">
								<button type="submit" class="btn btn-outline-primary btn-xxl"
									name="submitButton" id="registerButton" value="register">Register
									New Acc</button>
							</div>
						</div>
					</div>
			...
			<div class="row justify-content-center">
				<div class="row fs-5">
					<a href="/vet">Login as Veterinarian</a>
				</div>
				<div class="row fs-5">
					<a href="/petOwner/acc/forgetPassw">Forget Password</a>
				</div>
				<div class="row fs-6">
					<div class="col-12">
...
<script
	src="${pageContext.request.contextPath}/js/petOwnerPage/login.js"></script>
